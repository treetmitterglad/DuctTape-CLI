...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Mistral model for conversations (/settings)…',
  ...
  'Show DuctTape CLI status in the terminal window title (/settings)…',
  ...
  'Choose your Mistral model with /model…',
